...
public class LastSurvivorTest {
    ...
    @Test
    void simpleTest() {
        assertEquals("a", ls.findLastSurvivor("abc",  new int[]{1, 1}), String.format("letters: %s coords: %s", "abc", Arrays.toString(new int[]{1, 1})));
        assertEquals("b", ls.findLastSurvivor("kbc",  new int[]{0, 1}), String.format("letters: %s coords: %s", "kbc", Arrays.toString(new int[]{0, 1})));
        assertEquals("z", ls.findLastSurvivor("zbk",  new int[]{2, 1}), String.format("letters: %s coords: %s", "zbk", Arrays.toString(new int[]{2, 1})));
    }
    ...
    void enhancedTest() {
        ...
        assertEquals("d", ls.findLastSurvivor(str,  arr), String.format("letters: %s coords: %s", str, Arrays.toString(arr)));
    }
}
